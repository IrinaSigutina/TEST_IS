...
@Описание: Экспортный сценарий по перезаполнению константы ТолькоЗащищеннаяАутентификацияPOP3
@ПримерИспользования: И Перезаполнение константы ТолькоЗащищеннаяАутентификацияPOP3 значением
